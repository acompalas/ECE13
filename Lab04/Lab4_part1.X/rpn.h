...
enum rpn_error{
    RPN_NO_ERROR = 0,
    RPN_ERROR_STACK_OVERFLOW = 1,
    RPN_ERROR_STACK_UNDERFLOW = 2,
    RPN_ERROR_INVALID_TOKEN = 3,
    RPN_ERROR_DIVIDE_BY_ZERO = 4,
    RPN_ERROR_TOO_FEW_ITEMS_REMAIN = 5,
    RPN_ERROR_TOO_MANY_ITEMS_REMAIN = 6
};
